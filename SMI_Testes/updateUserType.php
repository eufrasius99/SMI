<?php
    ...
    $Type = filter_input( $_INPUT_METHOD, 'NTipo', FILTER_SANITIZE_STRING, $flags);
    
    $queryString = "UPDATE `smi_final`.`utilizador` SET idTipoUtilizador = $Type WHERE idUtilizador = $idUser";
